"use client";
import { Heart, HomeIcon, LogOutIcon, MessageCircle, SquarePlus } from 'lucide-react';
    ...
    const SidebarLinks =[
        {
            ...
            icon:(
                <Avatar className='w-9 h-9'>
                    <AvatarImage src={user?.profilePicture} className='h-ful w-full'/>
  ...
  return (
    <div className='h-full '>
        ...
        <div onClick={()=>{router.push("/");}} >
            <Image src='/images/logo.png' alt='Logo' width={150} height={150} className='mt-[2rem] " ' priority style={{ width: "auto", height: "auto" }}/>
        </div>
            <div className='mt-6 '>
