    ...
    <div className='w-full h-screen overflow-hidden'>
        <div className='grid grid-cols-1 lg:grid-cols-7 gap-8'>
            ...
            <div className='lg:col-span-4 h-screen hidden lg:block'>
                <Image src="/images/signup-banner.jpeg" alt="signup" width={1000} height={1000} className='w-full h-full object-cover'/>
            </div>
            {/* Form */}
            <div className='lg:col-span-3 flex flex-col items-center justify-center h-screen'>
                <h1 className='font-bold text-x1 sm:text-2xl text-left uppercase mb-8'>Sign Up with   <span className='text-rose-600'>ASHIMOTOT</span></h1>
                <form onSubmit={handleSubmit} className='block w-[90%] sm:w-[80%] md:w-[60%] lg:w-[90%] x1:w-[80%]'>
                <div className='mb-4'>
                    <label htmlFor='name'className='font-semibold mb-2 block'>
                        Username
                    </label>
                    <input type='text' name='username' placeholder='Username' className='px-4 py-3 bg-gray-200 rounded-lg w-full block outline-none' value={formData.username}onChange={handleChange}/>
                </div>
                <div className='mb-4'>
                    <label htmlFor='email'className='font-semibold mb-2 block'>
                        Email
                    </label>
                    <input type='email' name='email' placeholder='Email address' className='px-4 py-3 bg-gray-200 rounded-lg w-full block outline-none'value={formData.email}onChange={handleChange}/>
                </div>
                <div className='mb-4'>
                ...
                <h1 className='mt-4 text-lg text-gray-800'>Already have account ?{" "}
