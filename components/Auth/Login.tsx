...
const Login = () => {
    ...
    const handleSubmit = async(e: FormEvent) =>{
        ...
        const result = await handelAuthRequest(loginReq,setIsLoading);
    ...
    <div className='w-full h-screen overflow-hidden'>
        <div className='grid grid-cols-1 lg:grid-cols-7 gap-8'>
            ...
            <div className='lg:col-span-3 flex flex-col items-center justify-center h-screen'>
                <h1 className='font-bold text-x1 sm:text-2xl text-left uppercase mb-8'>Login with   <span className='text-rose-600'>ASHIMOTOT</span></h1>
